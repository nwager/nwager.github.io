...
var app = (function () {
    ...
    // (7:2) {#if (imgSrc && !Array.isArray(imgSrc))}
    function create_if_block(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(7:2) {#if (imgSrc && !Array.isArray(imgSrc))}",
    		ctx
    	});
    ...
    function create_fragment$1(ctx) {
    	...
    	let h2;
    	let t1;
    	let show_if = /*imgSrc*/ ctx[2] && !Array.isArray(/*imgSrc*/ ctx[2]);
    	let t2;
    	let p;
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h2, file$1, 5, 2, 119);
    			attr_dev(p, "class", "" + (null_to_empty("description") + " svelte-ib50qz"));
    			add_location(p, file$1, 9, 2, 253);
    			attr_dev(div, "class", "project svelte-ib50qz");
    			add_location(div, file$1, 4, 0, 95);
    		},
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	let { project } = $$props;
    	let { title, description, imgSrc } = project;
    	...
    	$$self.$capture_state = () => ({ project, title, description, imgSrc });
    	...
    	return [title, description, imgSrc, project];
    }
    ...
    const projects = [
        {
            ...
            imgSrc: "https://image.api.playstation.com/vulcan/img/rnd/202011/0714/Cu9fyu6DM41JPekXLf1neF9r.png",
        },
        {
            title: "Project 2",
