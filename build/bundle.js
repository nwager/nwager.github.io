...
var app = (function () {
    ...
    function create_else_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(img, "class", "svelte-1noxynw");
    			add_location(img, file$2, 12, 4, 296);
    		},
    ...
    function create_if_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(img, "alt", "Carousel");
    			attr_dev(img, "class", "svelte-1noxynw");
    			add_location(img, file$2, 10, 4, 232);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, img, anchor);
    		},
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(10:2) {#if Array.isArray(images)}",
    		ctx
    	});
    ...
    function create_fragment$2(ctx) {
    	...
    	function select_block_type(ctx, dirty) {
    		...
    		if (show_if == null) show_if = !!Array.isArray(/*images*/ ctx[0]);
    	...
    	const block = {
    		c: function create() {
    			div = element("div");
    			if_block.c();
    			attr_dev(div, "class", "carousel svelte-1noxynw");
    		...
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = listen_dev(div, "click", /*changeImage*/ ctx[2], false, false, false);
    				mounted = true;
    			}
    		},
    		p: function update(ctx, [dirty]) {
    ...
    function instance$2($$self, $$props, $$invalidate) {
    	...
    	function changeImage() {
    		...
    		$$invalidate(1, currentIndex %= images.length);
    	}
    	...
    	$$self.$capture_state = () => ({ images, currentIndex, changeImage });
    	...
    	return [images, currentIndex, changeImage];
    }
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	return [title, description, images, project];
    }

    class Project extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$1, create_fragment$1, safe_not_equal, { project: 3 });
    		...
    		if (/*project*/ ctx[3] === undefined && !('project' in props)) {
